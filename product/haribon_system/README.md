...
### Environmental Parameter Groups

- **Marine Hydrodynamics and Biogeochemistry (CMES)**: Chlorophyll-a concentration, sea surface temperature, sea surface salinity, zonal/meridional velocity, and mixed layer depth
- **Atmospheric and Terrestrial (GEE)**: Rainfall, wind, and vegetation
...
- Zonal/Meridional Velocity (uo, vo)
...
2. **Configure Database Connection**:
   ```bash
   cd product/haribon_system/backend
...
```bash
cd product/haribon_system/ml_xgboost
